...
if ($InstallBridge -eq "1") {
    ...
    $action = Initialize-UserTomlConfig `

        -TomlPath $bridgeCfgToml `

        -JsonPath $bridgeCfgJson `

        -TemplatePath $bridgeExampleToml `

        -LegacyJsonPath $legacyBridge
...
if ($InstallWeb -eq "1") {
    ...
    $action = Initialize-UserTomlConfig `
        ...
        -TemplatePath $webExampleToml `

        -LegacyJsonPath $legacyWeb
