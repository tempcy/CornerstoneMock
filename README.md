...
**当前版本：0.1.17**（变更见 [CHANGELOG.md](CHANGELOG.md)；安装包版本规则见 [installer/README.md](installer/README.md)）
...
- `**CornerstoneAgent/`**：边缘 Agent（A0 编排 + P0/P1 查数 + **A1 SQLite 时序**）；规则/信息窗口见 [CornerstoneAgent/AGENT.md](CornerstoneAgent/AGENT.md)、[ENTERPRISE.md](CornerstoneAgent/ENTERPRISE.md) 与 [PLAN.md](PLAN.md)。
...
| **Agent** | `cornerstone-agent` | 边缘编排 + P0/P1 查数 + A1 长周期时序（SQLite）；经 Bridge REST 取数。 |
